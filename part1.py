...
next_value = int(input("Enter a fourth number: "))
fifth_value = int(input("Enter a fifth value: "))
print("The sum of the numbers you entered is", first_value + second_value + third_value + next_value + fifth_value)
